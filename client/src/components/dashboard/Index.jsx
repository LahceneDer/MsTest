...
const Index = () => {
  ...
  return (
    <>
      <Typography variant="h4" style={{ margin: "1%", textAlign: "left" }}>
        MsTest Dashboard{" "}
      </Typography>
      <Grid style={{ margin: ".5% auto" }} container spacing={1}>
        ...
        <Grid item xs={5}>
          ...
          >
            <Typography variant="h5">
              {counts.suppliersCount > 0
                ? `${counts.suppliersCount} Supplier`
                : `No Supplier`}
            </Typography>
          </Paper>
        </Grid>
